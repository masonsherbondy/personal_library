...
#plot_variable_pairs defines two parameters, a dataframe and a list of continuous features up for grabs, and returns helpful visualizations of feature pairs.
